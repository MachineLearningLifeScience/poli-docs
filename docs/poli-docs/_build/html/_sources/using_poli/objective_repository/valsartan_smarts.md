...
An interface to [the Therapeutics Data Common's oracle for Valsartan SMARTS](https://tdcommons.ai/functions/oracles/#valsartan-smarts) {cite:p}`Huang:TDC:2021`. This objective function is part of the GuacaMol {cite:p}`Brown:guacamol:2019` benchmark.
