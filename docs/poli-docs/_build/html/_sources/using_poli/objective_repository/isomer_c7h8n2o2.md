...
This objective function optimizes towards a given SMILES/SELFIES that has a molecular formula of C7H8N2O2, and is part of the **Isomers** family of GuacaMol {cite:p}`Brown:guacamol:2019` benchmark. We compute it using [the Therapeutics Data Common's oracle](https://tdcommons.ai/functions/oracles/#multi-property-objective-mpo) {cite:p}`Huang:TDC:2021`.
